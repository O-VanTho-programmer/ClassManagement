...
import getClassStatsSum from '@/utils/getClassStatsSum';
...
export default function HubClassPage() {
    ...
    const classStatsSum = getClassStatsSum(stats);
        ...
        <div className="min-h-screen bg-gray-50 py-8">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col lg:flex-row justify-between items-center gap-6 mb-8">
                    ...
                    {/* Create Button */}
                    <Button color="blue" icon={Plus} onClick={() => setIsCreateModalOpen(true)} title="Create New Class" />
                </div>
