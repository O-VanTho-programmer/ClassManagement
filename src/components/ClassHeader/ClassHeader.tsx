...
export default function ClassHeader({ classInfo }: ClassHeaderProps) {
    ...
    return (
        <div className="flex flex-col w-full p-4 sm:p-8">
            ...
            <div className={`bg-white rounded-lg p-6 shadow-xl mt-6 transition-all duration-500 ease-in-out overflow-hidden ${showFullDetails ? 'max-h-screen opacity-100' : 'max-h-0 opacity-0 p-0'}`}>
