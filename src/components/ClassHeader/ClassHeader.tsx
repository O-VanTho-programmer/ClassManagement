import {  CalendarIcon, ChevronDownIcon, DollarSignIcon, UserIcon, UsersIcon } from "lucide-react";
...
export default function ClassHeader({ classInfo }: ClassHeaderProps) {
    ...
    return (
        <div className="flex flex-col w-full py-4 sm:py-8">
            ...
            <div className={`bg-white rounded-lg shadow-xl transition-all duration-500 ease-in-out overflow-hidden ${showFullDetails ? 'max-h-screen opacity-100 p-6 mt-2' : 'max-h-0 opacity-0 p-0'}`}>
