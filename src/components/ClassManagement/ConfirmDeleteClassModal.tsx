...
type ConfirmDeleteClassModalProps = {
    isOpen: boolean
    onClose: () => void
    onConfirm: ({ class_id }: { class_id: string }) => void
    isDeleting: boolean
        ...
        <div className="fixed inset-0 overlay flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden transform transition-all scale-100 animate-in zoom-in-95 duration-200">
                ...
                <div className="flex items-center justify-between p-5 border-b border-gray-100">
                    <h3 className="text-lg font-bold text-gray-900">Remove Class</h3>
                    <IconButton
                        icon={X}
                        onClick={onClose}
                        size={20}
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500 leading-relaxed">
                                You are about to remove <strong className="text-gray-900">{classData.name}</strong> from this class.
                                <br />
                ...
                <div className="p-5 border-t border-gray-100 bg-gray-50 flex justify-end gap-3">
                    ...
                    />
                    <button
                        onClick={() => onConfirm({ class_id: classData.id })}
                        disabled={isDeleting}
